...
const CourseNotFound = () => {
  return (
    <div className="flex flex-col items-center justify-between min-h-32 text-center">
      <AlertCircle className="text-red-500 h-16 w-16 mb-4" />

      <h1 className="font-bold text-2xl md:text-4xl text-gray-800 dark:text-gray-200">
        Course Not Found
      </h1>
